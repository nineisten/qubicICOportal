...
interface CloseProps extends GlobalHtmlAttributes{}
...
//View template
export default function Close(w:number,props:CloseProps){
    const {...attrs} = props
